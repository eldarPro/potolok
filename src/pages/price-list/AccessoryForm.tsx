    ...
    <IonPage>
      ...
      <IonContent>
        <IonList inset>
          ...
          <IonItem>
            <IonLabel position="stacked">Единица измерения</IonLabel>
          ...
          <IonItem>
            <IonLabel position="stacked">Цена клиенту (₽ / {form.unit})</IonLabel>
            <IonInput type="number" value={form.price} onIonInput={e => set('price', Number(e.detail.value) || 0)} />
          </IonItem>
          <IonItem>
            <IonLabel position="stacked">Зарплата за установку (₽ / {form.unit})</IonLabel>
